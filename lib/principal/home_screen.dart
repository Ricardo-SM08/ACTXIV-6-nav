  ...
  final List<Map<String, String>> listaAutos = [
    {
      ...
      "desc": "Motor V8, 450 HP. El clásico americano. Cuenta con interiores de piel.",
      "spec": "Año: 2024"
    },
    {
      ...
      "desc": "Diseño aerodinámico y gran potencia. Un muscle car de 4 puertas.",
      "spec": "Año: 2023"
    },
    {
      "titulo": "Nissan GT-R",
      "url": "https://raw.githubusercontent.com/Ricardo-SM08/imagenes-para-flutter-6-J-11-febrero-2026/refs/heads/main/r35.jpg",
      "desc": "El superdeportivo japonés por excelencia. Tracción integral inteligente.",
      "spec": "Año: 2024"
    },
    {
      ...
      "desc": "Compacto deportivo y versátil. Una leyenda de los años 90.",
      "spec": "Año: 1985"
    },
  ];
  ...
  final List<Map<String, String>> listaPiezas = [
    {
      ...
      "desc": "Aceite sintético de alta durabilidad que protege tu motor.",
    ...
    },
    {
      ...
      "desc": "Filtro de alto flujo que asegura una limpieza profunda.",
      "spec": "Universal"
    },
    {
      "titulo": "Rines",
      "url": "https://raw.githubusercontent.com/Ricardo-SM08/imagenes-para-flutter-6-J-11-febrero-2026/refs/heads/main/rines.jpg",
      "desc": "Juego de rines de aleación ligera. Mejoran la estética.",
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Nuestros Autos", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold)),
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(
                        context,
                        '/detalles',
                        arguments: {'producto': auto, 'esAuto': true},
                      );
                    },
                    child: ProductoCard(
                      titulo: auto["titulo"]!,
                ...
                Center(
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text("Más...", style: TextStyle(fontSize: 20)),
                    ),
                  ),
                ),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 20),
              const Text("Refacciones", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
              GridView.builder(
                shrinkWrap: true,
                physics: const NeverScrollableScrollPhysics(),
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(
                        context,
                        '/detalles',
                        arguments: {'producto': pieza, 'esAuto': false},
                      );
                    },
                    child: ProductoCard(
                      titulo: pieza["titulo"]!,
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Text(especificacion, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                    ],
                  ),
