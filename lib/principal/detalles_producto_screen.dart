...
class DetallesProductoScreen extends StatelessWidget {
  const DetallesProductoScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // Extracción de argumentos de la ruta
    final args = ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>;
    final producto = args['producto'] as Map<String, String>;
    final esAuto = args['esAuto'] as bool;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(producto['spec']!, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w500)),
                    ...
                    Text(
                      producto['desc']!,
                      style: const TextStyle(fontSize: 18, height: 1.2, color: Colors.black54),
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          esAuto ? "Iniciando contacto..." : "Agregando al carrito...",
